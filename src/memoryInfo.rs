fn print_memory_info(system_table: &mut SystemTable<Boot>) {
    ...
    println!("Memory map:");
    println!("{:16} {:16} {:8} {}", "Physical Addr", "Virtual Addr", "Num Pages", "Size", "Type");
    ...
    let heap_buf = system_table.boot_services().allocate_pool(MemotyType::LOADER_DATA, 1024).unwrap();
